...
cljs.core.UUID;
var hello_clojurescript = {add_todo:function(a) {
  return function() {
    a.todos.push({text:a.todoText, done:!1});
    return a.todoText = ""
  }
}, remaining:function(a) {
  return function() {
    return cljs.core.count.call(null, cljs.core.filter.call(null, function(a) {
      return cljs.core.not.call(null, a.done)
    }, a.todos))
  }
}, archive:function(a) {
  return function() {
    var b = cljs.core.into_array.call(null, cljs.core.filter.call(null, function(a) {
      return cljs.core.not.call(null, a.done)
    }, a.todos));
    return a.todos = b
  }
}, CTodoCtrl:function(a) {
  a.todos = [{text:"learn angular", done:!0}];
  a.addTodo = hello_clojurescript.add_todo.call(null, a);
  a.remaining = function() {
    return cljs.core.count.call(null, cljs.core.filter.call(null, function(a) {
      return cljs.core.not.call(null, a.done)
    }, a.todos))
  };
  a.archive = hello_clojurescript.archive.call(null, a)
}};
hello_clojurescript.TodoCtrl = ["$scope", hello_clojurescript.CTodoCtrl];
